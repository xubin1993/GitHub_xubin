...
class OpenPage():
    ...
    def Openpage(self,url):
        ip=''
        if  not self.key:
            ip_url='http://verx.daili666.com/ip/?tid=556313282996285&filter=on&num=1&foreign=only&ports=8080,80'
        ...
        self.opener = urllib2.build_opener(proxy_support,cookie_support,urllib2.HTTPHandler)#proxy_support
        ...
        try:
            ...
            self.opener.addheaders = [("User-agent",agent),('Host','http://www.google.cn'),("Accept","*/*")]
